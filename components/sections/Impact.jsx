      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid grid-cols-2 gap-4 lg:grid-cols-4">
          <Reveal className="col-span-2 row-span-2">
            <div
              className="flex h-full flex-col justify-between rounded-3xl border border-accent/30 bg-surface p-8"
              style={{
                background:
                  "radial-gradient(120% 100% at 8% 0%, rgba(217,164,65,0.16), transparent 60%), var(--color-surface)",
              }}
            >
